...
Use C<enhanced_altitude>, C<enhanced_speed>, C<enhanced_max_speed>, or C<enhanced_avg_speed> instead of
C<altitude>, C<speed>, C<max_speed>, or C<avg_speed> respectively,
when C<enhanced_...> ones are defined in FIT files.

Improvements by S<H>E<aring>S<kan Jerning>.
